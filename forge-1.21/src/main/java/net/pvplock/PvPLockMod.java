...
/**
 * Forge 51 build variant (Minecraft 1.21).
 *
 * Differences from the 1.21.11 build:
 *  - The @Mod constructor takes no arguments on Forge 51; the mod bus is fetched from
 *    FMLJavaModLoadingContext.get() instead. Forge 52 (1.21.1) starts injecting the
 *    context as a constructor parameter, which is why 1.21 needs its own variant.
